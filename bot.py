...
ADMIN_CHAT_ID = os.getenv("ADMIN_CHAT_ID")  # dit eget chat ID

# ===== DIT FILTER – ændr tallene her =====
MIN_LIQUIDITY = 10000    # $10k min likviditet
MIN_VOLUME_24H = 5000    # $5k min volumen
MAX_AGE_HOURS = 24       # max 24 timer gammel
# =========================================
...
async def monitor(app):
    ...
    print("Monitor startet – tjekker hvert 60s")
    while True:
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Bot er live. Jeg overvåger automatisk.")
